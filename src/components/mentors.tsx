  ...
  return (
    <section className="space-y-14">
      <div className="text-center">
        ...
        <p className="font-light text-lg lg:text-xl mt-2">{description}</p>
      </div>
          ...
          <div className="space-y-4 " key={mentor.name}>
            <div className="w-full h-[387px] overflow-hidden">
              <Image
                ...
                height={387}
                alt="akinlade Joseph"
                className="transition-all duration-500 hover:scale-110 ease-in-out grayscale w-full h-[387px] object-cover"
              />
            </div>
