...
const Footer = () => {
  // TODO: add social links to the buttons
  return (
    <footer className="bg-[#0B0922] text-white pt-20 overflow-hidden">
      <div className="container">
        <div className=" flex gap-11 lg:gap-44 items-start flex-col lg:flex-row">
          <div>
          ...
          <div>
            <nav className="text-[1.2rem]">
              <ul className="flex flex-col lg:flex-row lg:items-center gap-7 text-white">
                ...
                <li className=" hover:text-blue-500 transition-colors duration-300">
                  <Link href={"https://youtube.com/@x3lab-i1n?si=d0ZZhQK8zTnTw1-r"}>Podcast</Link>
                </li>
              </ul>
            </nav>
          </div>
        ...
        <div className="flex justify-end flex-col lg:flex-row gap-7 lg:gap-44 lg:gap">
          ...
          <div className="w-max space-y-4 lg:space-y- ">
            <span>Follow Us</span>
            <div className="flex items-center gap-4">
              <Link target="_blank" href={"https://www.facebook.com/people/X3-Lab/61566362912021/"}>
              ...
              <Link target="_blank" href={"https://youtube.com/@x3lab-i1n?si=d0ZZhQK8zTnTw1-r"}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <Link target="_blank" href={"https://www.instagram.com/thex3lab/"}>
              ...
              <Link target="_blank" href={"https://ng.linkedin.com/company/x3lab"}>
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
