...
const Header = () => {
  ...
  const navLinks = [
    ...
    { href: "/get-involved", label: "Get Involve" },
    { href: "/research-and-development", label: "Our Programs" },
    { href: "/contact-us", label: "Contact Us" },
  ]

  return (
    <header className="py-4 md:py-8 relative">
        ...
        <div className="hidden lg:block">
          <nav>
            <ul className="flex items-center gap-6">
              {navLinks.map((link) => (
                <li key={link.href} className="hover:underline hover:text-blue-500">
        ...
        <div className="lg:hidden absolute top-full left-0 right-0 bg-white shadow-lg z-50">
          <nav className="container py-4">
            <ul className="flex flex-col items-center space-y-6">
              {navLinks.map((link) => (
                <li key={link.href} className="hover:text-blue-500 text-center w-full">
                  <Link href={link.href} className="text-lg block">{link.label}</Link>
                </li>
              ))}
