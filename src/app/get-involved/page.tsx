...
const members = [
  ...
  },
  {
    ...
    image: "Rectangle 37 (1).png"
  },
  {
    name: "Victor Raji",
    role: "Front-end Developer",
    image: "Rectangle 37 (2).png"
  }
]
  ...
  return (
    <main className="space-y-24  pt-10">
      ...
      <section className=" lg:pb-44">
        <div className="container flex flex-col lg:flex-row justify-between lg:space-x-10 lg:gap-0 lg:w-max">
          <div className="space-y-6">
            <h2 className={cn(nomixa.className, "text-3xl")}>
              Partner <br className="hidden lg:block" /> With Us
            </h2>

            <p className="text-lg font-light pb-6 w-max">
          ...
          <div className="grid grid-cols-3 w-full gap-y-6 mt-10 lg:mt-0">
            <Image
              width={313}
              height={432}
              className="lg:translate-y-16 translate-y-6 rounded-md object-cover w-full "
            ...
            <Image
              width={313}
              height={432}
              className="lg:translate-y-0 rounded-md object-cover w-full "
            ...
            <Image
              width={313}
              height={432}
              className="lg:translate-y-32 translate-y-12 rounded-md object-cover w-full "
      ...
      <section className=" relative text-white">
        ...
        <div className="container flex items-center justify-center flex-col py-20 space-y-6">
          ...
          <p className="text-center font-light ">
            {" "}
            Every contribution helps us grow and provide more opportunities for creators.{" "}
            <br className="hidden lg:block" /> You can support X3Lab through donations, resource contributions, or by
